...
#
	...
	history = model.fit(sample_gen(training_files, feature_set, atom_type, atom_type_encoder, atom_pos, atom_pos_encoder, energy_scores, x_min, y_min, z_min, x_max, y_max, z_max, fdir), steps_per_epoch=1,epochs = 60, verbose=1, use_multiprocessing=True, validation_data=(feature_set, y_mse)) #, callbacks=[early_stopping]
